...
The common API converts RTC calendar fields to and from Unix `time_t` and `tmElements_t` representations. The RV-3028 is unusual because the device also provides a hardware Unix-time counter.
